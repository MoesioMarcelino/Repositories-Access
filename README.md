# :mag_right: Repositories Access

Repositories Access is a project developed on Bootcamp Rocketseat for help you to find your (and others) repositories. This project is able to find also details and issues about each repository added.
